...
#non ho alcun indizio se non la stringa incomprensibile
#quindi facciamo la criptoanalisi 
...
# hypothesis 1: il testo è scritto in inglese
# cerchiamo online quali sono i caratteri maggiormente usati nel alfabeto inglese
#  http://pi.math.cornell.edu/~mec/2003-2004/cryptography/subs/frequencies.html

# vediamo che la 'K' è "da sola", e possiamo pensare che
# K = I
voc = {'K': 'i'}
...
#è un processo tedioso quello di farlo lettera per lettera ma siamo arrivati a
