#la descrizione ci dice che stiamo usando una versione semplificata del DES.
#ricostruiamo il processo passo per passo

#1. prendi un plain text divisibile in blocchi da 12bit 'blocks'
#2. scegli una chiave da 8bits in length
#3. per ciascun blocco from i=0 while i<N esegui le seguenti operazioni
#4. ripeti le operazioni sul block i, from r=0 while r<R
#5. dividi il blocco in 2 6bit sections Lr,Rr
